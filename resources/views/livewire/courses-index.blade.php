<div>
   <div class="text-gray-200 py-4">
       <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex">
           ...
           <button class="focus:outline-none bg-white shadow-lg h-12 px-4 rounded-lg bg-purple-600 hover:bg-purple-900 text-white mr-4" wire:click="resetFilter">
               <i class="fas fa-archway text-xs  mr-2"></i>
               Todos los Cursos
           </button>

                              {{--BOTON DESPLEGABLE 1 CATEGORIAS Dropdown --}}
                                   
           <div class="relative mr-4" x-data="{open: false}">
               <button class="px-4 block h-12  rounded-lg overflow-hidden focus:outline-none bg-purple-600 hover:bg-purple-900 text-white shadow-lg" x-on:click="open = true">
               ...
               <div class="absolute right-0 w-40 mt-2 py-2 bg-white border rounded shadow-xl" x-show="open"  x-on:click.away="open = false">   
                   ...
                   @endforeach
                              ...
                              {{--BOTON DESPLEGABLE 2 NIVELES Dropdown --}}
       ...
       <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 mt-8 mb-8 bg-black">
           {{$courses->links()}}
       </div>
</div>
